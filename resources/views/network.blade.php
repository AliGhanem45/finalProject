...
<html lang="en">
  <head>
    ...
    <link rel="Icon" href="Img/Linkedin-favicon-48.png" sizes="32x32" />
      ...
      <div class="nav-container">
        ...
        <div class="nav-right">
          <ul>
            <li>
              <a href="index.html"
                ><img src="Img/home.png" class="menu-png" />
                <span>Home</span></a
              >
            </li>
            ...
            <li class="active-link">
              <a href="network.html"
                ><img src="Img/user.png" class="menu-png" />
            ...
            <li>
              <a href="index.html"
                ><img src="Img/briefcase.png" class="menu-png" />
                <span>Jobs</span></a
              >
            </li>
            ...
            <li>
              <a href="index.html"
                ><img src="Img/chat.png" class="menu-png" />
            ...
            <li>
              <a href="index.html"
                ><img src="Img/notification.png" class="menu-png" />
                <span>Notifications</span></a
              >
            </li>
            <li>
              <a href="index.html">
                <img src="Img/Profile.jpg" class="menu-png" id="profile" />
                <span>Me</span></a
              >
            </li>
            <li id="business-border">
              <a href="index.html"
                ><img src="Img/menu.png" class="menu-png" />
        ...
        <div class="sidebar">
          ...
          <div class="reference-links">
            <ul>
              ...
              <li>
                <a href=""
                  ><span>Following and followers</span><span>1005</span></a
                >
              </li>
              <li>
          ...
          <div class="footer">
            ...
            <div class="footer-tag">LinkedIn Corporation &copy; 2023</div>
          </div>
        </div>
        ...
        <div class="main-content">
          <div class="invitations">
            <div class="invite">
              <div class="profile">
                <img
                  src="Profile photos\male20171084100247834.jpg"
                />
                <div class="profile-user">
                  <h1>Phillip N McNabb</h1>
                  <h2>Survey Researcher</h2>
                </div>
              </div>
              <div class="response">
            ...
            <div class="invite">
              <div class="profile">
                <img
                  src="Profile photos\male2016108377597626.jpg"
                />
                <div class="profile-user">
                  <h1>Scott M Perry</h1>
            ...
            <div class="invite">
              <div class="profile">
                <img
                  src="Profile photos\male20151083711962921.jpg"
                />
                <div class="profile-user">
                  <h1>Louis P Pollard</h1>
                  <h2>Developer at Microsoft</h2>
                </div>
              </div>
              <div class="response">
                <button type="button" class="accept">Accept</button>
          ...
          <div class="ad">
            <h1>Achieve your goals faster with Premium</h1>
            <h2>
